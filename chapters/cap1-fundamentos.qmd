...
Medida (mm)
      ^
 10,15|                                 (X) FORA DE CONFORMIDADE (Refugo)
      |------------------------------------------------------------------ LSE (Limite Superior)
 10,10|                          (X)  (X)
      |                   (X)  (X)
 10,05|            (X)  (X)             <-- DERIVA (O processo está "subindo")
      |     (X)  (X)
 10,00|__(X)_____________________________________________________________ ALVO (Projeto)
      |
  9,95|
      |------------------------------------------------------------------ LIE (Limite Inferior)
  9,90|
      |__________________________________________________________________> Tempo (Turno)
...
______|_________\____________/_________  (A) VISÃO TRADICIONAL
      ...
      |__________|____|_____|__________>  Valor da Característica
                LIE  ALVO  LSE
```
*(Onde LIE = Limite Inferior de Especificação e LSE = Limite Superior de Especificação)*
