...
```text
      [ ENGENHEIRO PRODUCT-OUT ]               [ ENGENHEIRO MARKET-IN ]
        "O Guardião da Fábrica"                  "O Arquiteto de Valor"

               OBJETIVO                                 OBJETIVO
      Otimizar a máquina e o custo             Resolver o problema do cliente
        interno de produção.                     final e interno.

            PRIORIDADES                              PRIORIDADES
      1. Especificação Técnica                 1. Necessidade do Usuário
      2. Velocidade da Linha                   2. Facilidade de Uso (UX)
      3. Redução de Refugo                     3. Valor Percebido

          VISÃO DO ERRO                            VISÃO DO ERRO
      "O cliente não sabe usar                 "O processo falhou em entender
        o que nós projetamos."                   o que o cliente precisa."

        RELAÇÃO INTERNA                          RELAÇÃO INTERNA
      Entrega o que está no                    Pergunta ao próximo processo:
      script e "passa a bola".                 "Como posso facilitar seu trabalho?"

            SUCESSO                                  SUCESSO
      Bater a meta de produção.                Bater a meta de satisfação.
```
