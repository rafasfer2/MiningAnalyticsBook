...
Existe um custo sutil e perigoso: a **Superqualidade**. Ocorre quando a engenharia entrega atributos que o cliente não pediu, não valoriza e, consequentemente, não paga por eles.
...
**O Problema:** Uma fábrica de notebooks avalia se deve testar as telas de seus aparelhos. A inspeção custa R$ 50,00 por máquina. Se o notebook não for testado e chegar com defeito ao cliente, o custo de garantia, frete e substituição é de R$ 10.000,00 por caso.

* **Debate 1:** Considerando um lote de 1.000 notebooks com taxa histórica de falha de 1%, qual a decisão financeiramente mais inteligente para o Engenheiro de Qualidade? Inspecionar todos ou pagar a garantia dos que falharem?
...
Para consolidar a visão analítica, considere uma fábrica onde as funções de custo (em Reais) foram modeladas da seguinte forma:
...
::: {.callout-note title="📈 O Insight do Engenheiro"}
O objetivo da gestão não é o gasto zero, mas o **equilíbrio**:
* **Aumentar** Prevenção e Avaliação...
* Para **eliminar** Falhas Externas e reduzir Falhas Internas...
* Até que o **Custo Total** atinja seu valor mínimo. E **cortar** a Superqualidade que não agrega valor.
:::
...
**1. Modelagem Matemática: O Custo do "Enchimento Excessivo"**
