...
2. **Measure (Medir):** Desenhar as entradas e saídas (onde Q=f(x)), estabelecendo o sistema de medição adequado e coletando dados por meio de amostragem representativa. Calcular a capacidade atual do processo (Cp, Cpk).
...
3. **Perspectiva dos Processos Internos:** Eficiên cia operacional, qualidade dos processos e inovação.
