...
### O Mapeamento Sistêmico: ISO 9001 e a Engenharia de Dados {#sec-mapeamento-iso-qualidade}
...
**Desafio do Engenheiro: Falha Sistêmica no TQM**
...
**Desafio Prático do Módulo: Estruturando um 5W2H**
...
```
      ...
      |                                      |                                      |
 [ FILOSOFIAS ]                        [ METODOLOGIAS ]                       [ FERRAMENTAS ]
      |                                      |                                      |
      |-- TQM: Cultura e Pessoas             |-- ISO 9001: Gestão de Riscos         |-- PDCA / MASP: Solução
      |-- LEAN: Fluxo e Valor (Mudas)        |-- MEG: Maturidade e Aprendizado      |-- 5S: Base e Organização
      |-- 6 SIGMA: Redução de Variação       |-- VPS/BSC: Estratégia e Pilares      |-- ISHIKAWA: Causa Raiz
      |-- 5S: Base da Estabilidade           |-- SGQ: Processos e Requisitos        |-- 5W2H: Plano de Ação
      |______________________________________|______________________________________|
                                             |
                                   [ O CICLO DE ENTREGA ]
                                             |
               ...
               (Projeto/Padrão)       (Ativo/Confiabilidade)   (Uso/Produtividade)
                      |                      |                      |
                O QUE fazer?            COMO manter?           QUANTO produzir?
                      |______________________|______________________|
                                             |
                                  [ RESULTADO SISTÊMICO ]
                                             |
                       ______________________|______________________
                      |                      |                      |
               VALOR AO CLIENTE       EFICIÊNCIA DE CUSTO      ZERO DANOS (HSE)
```
...
::: {#exr-diagnostico-padaria}

**Diagnóstico de Consultoria: A Padaria Industrial**
...
| **Filosofia** | A Abordagem de Processos: Input (Entrada) $\rightarrow$ Transformação $\rightarrow$ Output (Saída). | Lean Manufacturing: A busca implacável por eliminar os 8 desperdícios (Mudas). | O valor econômico só é gerado naquilo que o cliente está disposto a pagar. O resto é custo. |
