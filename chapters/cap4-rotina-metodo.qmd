...
# O Cérebro da Operação: Modelos de Gestão e Desdobramento {#sec-cap4}
...
* **Passo 3: Descoberta da Causa Raiz:** Esqueça o "achismo". Utilize dados.
  ...
  * *Qual atacar primeiro?* Filtre as causas com a Matriz GUT e desça até a raiz com os 5 Porquês. *(Nota: O passo a passo matemático para construir cada uma destas ferramentas será detalhado na nossa "Caixa de Ferramentas" no @sec-cap5).*
...
## A Construção Coletiva da Qualidade e o Foco na Operação {#sec-chao-de-fabrica}
