...
Uma mineradora globalde grande porte pode publicar em seu formulário de referência anual:

**"Guidance de Produção 2024:**
* Minério de Ferro: 310-320 Mtpa
* Níquel: 170-180 kt
* Cobre: 320-355 kt"

Essa é a projeção oficial. O mercado ajusta suas expectativas com base nessa informação. Se a empresa entregar 307,8 Mt de minério (como no exemplo real), ela ficou abaixo da faixa inferior, gerando impacto no valor de mercado e gatilhos de análise crítica.
:::
...
* **Se a equipe possui TODAS as condições operacionais e analíticas:**
  Assumir uma captura **≥50%** da lacuna como meta anual.

* **Se a equipe possui PARTE das condições, mas suporta desafios de melhoria:**
  Captura da lacuna gira em torno de **20% a 50%**.

* **Se a equipe está em estágio reativo, limitando-se a gestão da rotina:**
  Captura da lacuna deve ser conservadora, girando em torno de **10% a 20%** do gap disponível.
...
Para consolidar os conceitos deste capítulo, consulte a seção [**Capítulo 4 — Alma Estratégica**](cap8-exercicios-parte1.qmd#sec-cap8-cap4) no [**Capítulo 8: Exercícios Integrados da Parte I**](cap8-exercicios-parte1.qmd#sec-cap8-exercicios).
