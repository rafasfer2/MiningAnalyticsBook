...
Com a expansão para 10 dilemas, o espaço amostral do julgamento situacional atinge o volume necessário para a estabilidade algorítmica. O sistema injeta um vetor de pontos (+5 ou +0) nos perfis correspondentes a cada decisão exclusiva.

```{r}
#| label: tbl-pesos-sjt
#| tbl-cap: "Matriz de Injeção de Pesos ($w_{SJT}$) por Perfil e Dilema"
#| echo: false
#| message: false
#| warning: false
...
fmt_peso <- function(v) ifelse(v == 5, cell_spec("+5.0", bold = TRUE), "+0.0")

pesos_raw <- rbind(
  # Dilemas 1–6 (originais)
  c(5,0,0,0,0,5), c(0,5,0,5,0,0), c(0,0,5,0,5,0),
  c(0,0,0,0,0,5), c(0,0,5,5,0,0), c(5,0,0,0,5,0),
  c(5,0,0,0,0,5), c(0,5,0,0,5,0), c(0,0,5,5,0,0),
  c(5,0,0,0,0,5), c(0,0,0,5,5,0), c(0,5,5,0,0,0),
  c(0,0,0,5,0,5), c(0,0,5,0,5,0), c(5,5,0,0,0,0),
  c(0,0,5,5,0,0), c(0,0,0,0,5,5), c(5,5,0,0,0,0),
  # Dilema 7 — Cadeia de Suprimentos (ISO 9001/Lean)
  c(5,0,0,0,0,5), c(0,5,0,0,5,0), c(0,0,5,5,0,0),
  # Dilema 8 — Segurança Cibernética (ISO 27001)
  c(5,0,0,0,0,5), c(0,0,5,0,5,0), c(0,5,0,5,0,0),
  # Dilema 9 — Manutenção de Ativos (ISO 55001)
  c(5,0,0,0,0,5), c(0,5,5,0,0,0), c(0,0,0,5,5,0),
  # Dilema 10 — Qualificação de Pessoal (NR-11)
  c(5,0,0,0,0,5), c(0,0,0,5,5,0), c(0,5,5,0,0,0)
)
...
opcoes <- c(
  ...
  "\u21b3 A. Qualidade/Processos", "\u21b3 B. Risco/Contingência", "\u21b3 C. Operacional/Custos",
  "\u21b3 A. Segurança/Info",      "\u21b3 B. Negoc./Criativo",    "\u21b3 C. Produção/Risco",
  "\u21b3 A. Engenh./Confiab.",   "\u21b3 B. Monit./Eficiência", "\u21b3 C. Run-to-Failure",
  "\u21b3 A. Segurança/Legal",     "\u21b3 B. Liderança/Contorno", "\u21b3 C. Eficiência/Oculto"
)
