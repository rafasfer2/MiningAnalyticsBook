...
O IQPL é a consolidação da nossa equação de qualidade multidimensional (@eq-arm-multi) em uma nota cuja pontuação máxima atinge 100 pontos. Para garantir o rigor técnico, o modelo foi desdobrado em um total de **35 variáveis ($x_i$)**, metodicamente agrupadas em **5 áreas de interesse ($D_j$)**:
