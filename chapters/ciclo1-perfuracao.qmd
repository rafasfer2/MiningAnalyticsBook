...
drill_events_mine_d %>%
    ...
    knitr::kable(caption = "(#tab:drill-events) Sequência de eventos brutos da DRILL_100")
```
...
drill_events_mine_d %>%
    ...
    knitr::kable(caption = "(#tab:imputed-phases) Detalhamento de eventos com fases imputadas (DRILL_100)")
```
